...
%
%% moving toward
\newcommand{\variables}{problems/variables_solved.csv}
\IfFileExists{\variables}{\DTLloaddb{variables}{\variables}}{\relax}

%%% https://tex.stackexchange.com/questions/53323/how-to-check-if-a-datatool-db-has-an-existing-member/53395#53395
%%% Werner's patch
\usepackage{etoolbox}
\makeatletter
...
\newcommand*{\V}[1]{%
  \ErrorFreeDTLgetlocation{\RowIndex}{\ColIndex}{variables}{#1}%
  \ifx\RowIndex\@@dtlnovalue
    =>var #1 not found<=
  \else
    \DTLfetch{variables}{ch_pr_var}{#1}{latex_\whichBook}
  \fi
}
\makeatother
...
\newcommand{\RomanNumeralCaps}[1]{\MakeUppercase{\romannumeral #1}} % I ADDED 
